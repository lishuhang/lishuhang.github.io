...
![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/02.png)

这个演示说明文心 API 可以联网读取内容，不过我手头的文心一言不能联网。

下图我提供的网址是「长安逸达」车型的官网，我希望它写一篇关于该车型的介绍文案。但它给我返回的是来源不明的「长安欧尚A5」的介绍。

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/03.png)

我想知道它是从哪里获取这些介绍信息的，它最后进入了编造模式。最后一张图说明，它肯定没有去看那个网址。

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/04.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/05.png)
...
![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/06.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/07.png)
...
![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/08.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/09.png)

在文心一言里我生成了两次，结果大同小异。

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/10.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/11.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/12.png)

二是生成活动邀请函。

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/13.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/14.png)

我用了稍微不一样的 prompt，文心一言的完成度还要比演示稍微高一点。

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/15.png)

值得注意的是，在结合上下文之后，它可以代入角色来生成适合角色的内容。下面这个问题，我本来没预期它会继续以上一篇「百度智能云」的身份说话。

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/16.png)
...
![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/17.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/18.png)

不过接下来让它写投资建议书时，它好像又把错误的数字改过来了。

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/19.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/20.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/21.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/22.png)
...
![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/23.png)

然后，我把一篇文章贴给它，让它基于文本总结重要信息。它基本上把带数字的部分都总结出来了。

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/24.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/25.png)

但当我让它基于上述信息再次抽象为表格时，它出错了。

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/26.png)

此后我换了一种方式提问，得到的结果更有趣了：

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/27.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/28.png)
...
![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/29.png)
...
![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/30.png)

同样的任务在 ChatGPT 里结果是这样的，也是我预想的输出结果。

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/31.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/32.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/33.png)
...
![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/34.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/35.png)

因为聊天界面只能输入和输出文字，我测试这一环节采用了一个有趣的方法，让 AI 模仿人手告诉我需要进行的每一步操作。先来看看 ChatGPT 的示范：

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/36.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/37.png)
...
![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/38.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/39.png)

现在轮到文心一言了。

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/40.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/41.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/42.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/43.png)
...
![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/44.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/45.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/46.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/47.png)

我额外加了一个指令：

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/48.png)

你觉得怎么样？

演示过程此后调用虚拟人，把生成的文案慷慨激昂地念了出来。

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/49.png)

二是让它制定一段行程规划，这里可以嵌入旅游产品的购买链接。

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/50.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/51.png)
...
![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/52.png)
...
![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/53.png)

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/54.png)

在文心一言中，生成的结果稍微简略一些。

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/55.png)
...
![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/56.png)

这里的现有内容，以及使用文心生成的结果，如果哪个质量更好，就可以替代另外一个。

就像必应 GPT 那样，在合适的场合，它会在回答中给出常规搜索提供的小插件：

![](/img/2023/03/29/rang-wen-xin-yi-yan-ban/57.png)
