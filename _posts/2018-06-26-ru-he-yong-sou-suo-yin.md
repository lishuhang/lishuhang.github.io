...
如同上面我们说过的一样，虽然算法是普遍存在的，然而人的思维是有盲区的。所以，算法优化的方向也是由人来指定的，那么**它也只会把一个已经知道的位置去扫描得事无巨细，却完全管不到它和它的设计者可能想象不到的地方。**
