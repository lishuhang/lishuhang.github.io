...
categories: 文章
tags: [科技]
image: https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/01.png
---
...
![](https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/01.png)
...
有在国内的小伙伴登记了内测资格，并且得到安装包，之后就放出来了。并且很快也有了在百度网盘等等地方的备份。在你看完本文后，关注航通社（微信ID：lifeissohappy）公众号并回复 edge 即可获取下载地址。

![](https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/02.png)
...
![](https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/03.png)
...
![](https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/04.jpg)

你可以随个人喜好自由定制显示新标签页的哪一部分。

![](https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/05.png)

这款Edge基本上可以让一个习惯使用Chrome的用户无缝切换，菜单布局，功能设置等等分毫不差。为了做到体验上的完全对接，Edge这一测试版甚至连浏览器标签页一行、后退前进等按钮和地址栏一行和书签栏一行的高度都做到了跟Chrome平齐。

![](https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/06.png)
...
![](https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/07.png)

因此在这一版本的Edge上面可以随意安装来自Chrome应用店的插件。Edge会自动检测到你访问了谷歌商店，并且提示你要安装的话，需要到扩展管理页面去打开安装第三方插件的开关。

![](https://mmbiz.qpic.cn/mmbiz_png/AdRKyBVLoHIYAPZafV1Lx7Vdlhu3ftKQCMhFhHYQhBvh0mAnWO3Jic2QvfQluX92pKfunS9KXibZD51o1RRhpmKQ/640?wx_fmt=png)

Edge对于Chrome扩展可以完全识别并且以相同的效果加载，但对于Chrome的皮肤，在安装时会显示出错。

![](https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/09.png)

![](https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/10.png)

![](https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/11.png)

![](https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/12.png)
...
![](https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/13.png)
...
![](https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/14.gif)

IE单独设置的Active X控件是为了在网页实现Windows更新而引入的，虽然后世褒贬不一，但是确实为比较高级复杂的程序功能在网页端实现开辟了一个先例。

![](https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/15.png)

此后，基于Active Desktop的实践发展而来的，用封装网页做可执行程序的hta格式，也成为Windows操作系统的一个有机组成部分。Windows XP的部分功能演示页面，以及开箱引导、激活向导等界面均使用hta完成。

![](https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/16.png)

现在随着风水轮流转，轮到谷歌通过自己的浏览器霸主地位，不断的为其他有可能会影响到自身生态的竞争对手设置障碍，有的时候你可以认为这是专指微软。

Edge团队的一名前实习生曾指责谷歌通过设计自家YouTube网站，使其在浏览器上表现不佳，从而故意“负优化”Edge浏览器。具体来说，该实习生指控YouTube在视频播放器的顶部添加了一个空<div>。这使得微软的EdgeHTML内核无法使用其视频加速功能，同时比Chromium更耗电。对此YouTube发言人予以否认。
...
![](https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/17.jpg)
...
关注航通社（微信ID：lifeissohappy）公众号并回复 edge 即可获取下载地址。

![](https://lishuhang.me/img/2019/03/26/wo-yong-shang-le-wei-ruan/18.jpg)
